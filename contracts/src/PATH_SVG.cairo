...
mod PATH_SVG {
    ...
    use path_on_chain::random_utils::pseudo_random_range;
    ...
    impl PATH_SVGImpl of super::IPATH_SVG<ContractState> {
        fn generate_svg(
            ...
            let (targets, mut rand_index) = self._find_targets(
                token_id,
                rand_index,
                WIDTH,
                HEIGHT,
            ...
            let (thought_steps, mut rand_index) = self._find_steps(
                token_id,
                rand_index,
                @targets,
                WIDTH,
            ...
            let (will_steps, rand_index_next) = self._find_steps(
                token_id,
                rand_index,
                @targets,
                WIDTH,
            ...
            let (awa_steps, rand_index_next) = self._find_steps(
                token_id,
                rand_index,
                @targets,
                WIDTH,
            ...
            let sigma = if all_minted { 30_u32 } else { 3_u32 };

            let mut defs: ByteArray = Default::default();
            if if_thought_minted {
                // Minted token hides this strand.
            } else {
        ...
        fn get_token_metadata(
            ...
            metadata.append(
                @"\",\"description\":\"PATH NFT with dynamic on-chain SVG\",\"image\":\"",
            );
    ...
    impl InternalImpl of InternalTrait {
        ...
        fn _to_cubic_bezier(
            ...
            while i < last_index {
                let p0 = if i == 0_usize { *steps.at(0_usize) } else { *steps.at(i - 1_usize) };
                let p1 = *steps.at(i);
        ...
        fn _clamp_i128(self: @ContractState, value: i128, min_value: i128, max_value: i128) -> i128 {
